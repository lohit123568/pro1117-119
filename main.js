...
document.getElementById("skecthtobedrawn").innerHTML = "Sketch To Be Drawn : "+Element_of_array;
...
function updateCanvas() {
    background("white");
    sketch = Element_of_array;
    document.getElementById("skecthtobedrawn").innerHTML = "Sketch To Be Drawn : "+sketch;
}
